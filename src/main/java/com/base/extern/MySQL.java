...
public class MySQL
{
     ...
     * @return The method returns:<br/>
     *         An empty-String = if the validation is successfully.<br/>
     *         None empty-String = It contains the error-message.
     */
    ...
    private boolean of_run_update(String sql_insert_update, boolean bool)
    {
        ...
        catch (SQLException exception)
        {
            if(bool)
            {
                Sys.of_sendErrorMessage(exception, "MySQL", "of_run_update("+ true +");", sql_insert_update);
            }
        }
     ...
     * @param sql_insert_update The sql-statement which will be executed.
     * @return TRUE = SUCCESS, FALSE = ERROR - <b>MessageManager will be displayed in the console!</b>.
     */
     ...
     * @param sql_insert_update The sql-statement which will be executed.
     * @return TRUE = SUCCESS, FALSE = ERROR - <b>No MessageManager will be displayed in the console!</b>.
     */
    ...
    private String of_getRowValue(String sql_select_query, String column_name, boolean bool)
    {
        ...
        catch (SQLException exception)
        {
            if(bool)
            {
                Sys.of_sendErrorMessage(exception, "MySQL", "of_getRowValue("+ true +");", sql_select_query);
            }
        }
